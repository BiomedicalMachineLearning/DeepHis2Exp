...
for fold  in range(36):
    ...
    matched_spot_expression_pred_1 = np.load(f"her2_subset/preds_{fold}/matched_spot_expression_pred.npy")
    ...
    df.to_csv(f"../../results/her2t_new/bleep_cor_{samps[fold]}.csv")
