...
if SAVE_EMBEDDINGS:
    for fold in range(9):
        save_embeddings(model_path=f"clip_visium_bc/best_{fold}.pt", save_path=f"clip_visium_bc/embeddings_{fold}/",
...
for fold  in range(9):
    ...
    save_path = f"clip_visium_bc/embeddings_{fold}/"
    ...
    df.to_csv(f"../../results/ffpe/bleep_cor_{samps[fold]}.csv")
