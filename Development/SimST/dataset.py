...
class ViT_HER2ST(torch.utils.data.Dataset):
    ...
    def __init__(self,mode="train",fold=0, pretrained_model="swim_s", r=4,flatten=False,ori=True,adj=True,prune='Grid',neighs=4):
        ...
        if pretrained_model =="efficientnet":
            self.ft_dir = '/QRISdata/Q2051/Yuanhao/33samples_Regclass/Exp3/Latent_Space/efficientnet.pkl'
        elif pretrained_model =="swim_s":
            self.ft_dir = '/QRISdata/Q2051/Yuanhao/33samples_Regclass/Exp3/Latent_Space/swim_s.pkl'
        elif pretrained_model =="resnet":
            self.ft_dir = '/QRISdata/Q2051/Yuanhao/33samples_Regclass/Exp3/Latent_Space/resnet.pkl'
