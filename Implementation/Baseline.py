...
if dataset_name == "Skin_Melanoma":
    if model_name in ["stnet", "deeppt", "stimage", "bleep", "deepspace"]:
        full_train_dataset = Skin_Melanoma(train=True,fold=fold,r=112, neighs=8, gene_list=target_gene_list, color_norm=colornorm, exp_norm=exp_norm, num_subsets=100)
        test_dataset = Skin_Melanoma(train=False,fold=fold, r=112, neighs=8, gene_list=target_gene_list, exp_norm=exp_norm, color_norm=colornorm, num_subsets=100)
    else:
        full_train_dataset = Skin_Melanoma(train=True,fold=fold,r=112, neighs=8, gene_list=target_gene_list, color_norm=colornorm, exp_norm=exp_norm, num_subsets=15)
        test_dataset = Skin_Melanoma(train=False,fold=fold, r=112, neighs=8, gene_list=target_gene_list, color_norm=colornorm, exp_norm=exp_norm, num_subsets=15)
    ...
    if model_name in ["stnet", "deeppt", "stimage", "bleep", "deepspace"]:
        ...
        full_train_dataset = CSCC(train=True,fold=fold,r=112, neighs=8, color_norm=colornorm, exp_norm=exp_norm, num_subsets=1, gene_list=target_gene_list)
        test_dataset = CSCC(train=False,fold=fold,r=112, neighs=8, num_subsets=1, color_norm=colornorm, exp_norm=exp_norm, gene_list=target_gene_list)
    ...
    if model_name in ["stnet", "deeppt", "stimage", "bleep", "deepspace"]:
        ...
        full_train_dataset = Her2st(train=True,fold=fold, num_subsets=1, r=112, neighs=8, color_norm=colornorm, exp_norm=exp_norm, gene_list=target_gene_list)
        test_dataset = Her2st(train=False,fold=fold,r=112, num_subsets=1, neighs=8, color_norm=colornorm, exp_norm=exp_norm, gene_list=target_gene_list)
