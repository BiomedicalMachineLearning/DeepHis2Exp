...
parser.add_argument('--singlejob', type=bool, default=True, help='HPC cluster')
...
# gene_list = "func"
if singlejob:
    for model_name in ["stnet", "deeppt", "stimage", "bleep", "deepspace", "hist2st", "histogene"]: 
