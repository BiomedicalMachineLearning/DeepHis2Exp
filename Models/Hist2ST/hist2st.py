...
from Models.Hist2ST.gcn import *
from Models.Hist2ST.NB_module import *
from Models.Hist2ST.transformer import *
...
class Hist2ST(pl.LightningModule):
    def __init__(self, learning_rate=1e-5, fig_size=112, label=None, 
                 dropout=0.2, n_pos=4000, kernel_size=5, patch_size=7, n_genes=785, 
