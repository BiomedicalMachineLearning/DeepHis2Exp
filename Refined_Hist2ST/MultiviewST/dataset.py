...
class ViT_HER2ST(torch.utils.data.Dataset):
    ...
    def __init__(self,mode="test",fold=0, r=4,flatten=True,ori=False,adj=False,prune='Grid',neighs=4):
...
#         samples = ['A1','B1','C1','D1','E1','F1','G2']
        ...
        val_names = list(set(samples)-set(te_names))[:6]
        print("Validation sample:", val_names)
        tr_names = list(set(samples)-set(te_names)-set(val_names))
