...
def pk_load(fold, mode='train', reg_ft="resnet", cls_ft="swim_s", flatten=False,dataset='her2st',r=4,ori=True,adj=True,prune='Grid',neighs=4):
    assert dataset in ['her2st','cscc']
    if dataset=='her2st':
        dataset = ViT_HER2ST(
            mode=mode,fold=fold, flatten=flatten,
