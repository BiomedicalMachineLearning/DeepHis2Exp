...
class ViT_HER2ST(torch.utils.data.Dataset):
    ...
    def __init__(self,mode="train",fold=0, pretrained_model="swim_s", r=4,flatten=False,ori=True,adj=True,prune='Grid',neighs=4):
        super(ViT_HER2ST, self).__init__()
        
        self.cnt_dir = '/scratch/imb/uqxjin3/Yuanhao/Hist2ST/data/her2st/data/ST-cnts'
        self.img_dir = '/scratch/imb/uqxjin3/Yuanhao/Hist2ST/data/her2st/data/ST-imgs'
        self.pos_dir = '/scratch/imb/uqxjin3/Yuanhao/Hist2ST/data/her2st/data/ST-spotfiles'
        self.lbl_dir = '/scratch/imb/uqxjin3/Yuanhao/Hist2ST/data/her2st/data/ST-pat/lbl'
        if pretrained_model =="efficientnet":
            self.ft_dir = '/scratch/imb/uqxjin3/Yuanhao/33samples_Regclass/Exp3/Latent_Space/efficientnet.pkl'
        elif pretrained_model =="swim_s":
            self.ft_dir = '/scratch/imb/uqxjin3/Yuanhao/33samples_Regclass/Exp3/Latent_Space/swim_s.pkl'
        elif pretrained_model =="resnet":
            self.ft_dir = '/scratch/imb/uqxjin3/Yuanhao/33samples_Regclass/Exp3/Latent_Space/resnet.pkl'
        
        self.r = 224//r

        # gene_list = list(np.load('data/her_hvg.npy',allow_pickle=True))
        gene_list = list(np.load('/scratch/imb/uqxjin3/Yuanhao/Hist2ST/data/her_hvg_cut_1000.npy',allow_pickle=True))
...
#         samples = ['A1','B1','C1','D1','E1','F1','G2']
        ...
        self.ft_dict = self.get_ft(self.ft_dir)
    ...
    def __getitem__(self, index):
        ...
        data=[patches, positions, exps, label, ft]
        if self.adj:
            data.append(adj)
        if self.ori:
    ...
    2: gene expression(log1p transformed)
    3: cell types
    4: latent space from pretrained model
    5: adjancy matrix
    6: original gene expression
    ...
    """
    ...
    def get_ft(self, ft_dir):
        # Read dictionary pkl file
        with open(ft_dir, 'rb') as fp:
