...
adata_dict = {**adata_dict1, **adata_dict2}
...
def evall(test_sample, gene_list):
    ...
    df.to_csv("../../results/ffpe/hist2st_cor_{}_{i}.csv".format(test_sample, i))
    ...
    with open(f"../../results/ffpe/hist2st_preds_{test_sample}_{i}.pkl", 'wb') as f:
        pickle.dump([pred_adata,test_dataset], f)


evall("FFPE", gene_list)
