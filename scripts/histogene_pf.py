...
def evall(test_sample, gene_list):
    ...
    with open(f"../../results/pf/histogene_preds_{test_sample}_{i}.pkl", 'wb') as f:
    ...
    for gene in pred_adata.var_names:
        ...
        df = df.append(pd.Series([gene, cor_val, test_sample, "histogene"], 
    ...
    df.to_csv("../../results/pf/histogene_cor_{}_{i}.csv".format(test_sample, i))

    with open("../../results/pf/histogene_times.txt", 'a') as f:
