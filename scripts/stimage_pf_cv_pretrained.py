...
with open(f"../results/pf_cv2/stimage_preds_{test_sample}_pretrained.pkl", 'wb') as f:
...
df.to_csv("../results/pf_cv2/stimage_cor_{}_pretrained.csv".format(test_sample))

with open("../results/pf_cv2/stimage_times_pretrained.txt", 'a') as f:
