...
df.to_csv("../results/her2st/stnet_cor_{}.csv".format(test_sample))


with open("../results/her2st/stnet_times.txt", 'a') as f:
    f.write(f"{test_sample} {end_train - start_train} - {time.strftime('%H:%M:%S', time.localtime())}")

with open(f"../results/her2st/stnet_preds_{test_sample}.pkl", 'wb') as f:
