...
## Define Your Paths
if(resolution == "low"){
  image_path <- paste0(dataDir,"/",sampleName,"/spatial/tissue_hires_image.png")
}else if (resolution == "high"){
  image_path <- paste0(dataDir,"/",sampleName,"/CropImage/size_",extraSize,"/transpose_image.tif")
}

scalefactor_path <- paste0(dataDir,"/",sampleName,"/spatial/scalefactors_json.json")

tissue_path <- paste0(dataDir,"/",sampleName,"/spatial/tissue_positions_list.csv")

cluster_path <- paste0(dataDir,"/",sampleName,"/analysis/clustering/graphclust/clusters.csv")

matrix_path <- paste0(dataDir,"/",sampleName,"/filtered_feature_bc_matrix/")
