...
def adata_subset_in_tissue(adata):
...
adata_dict0 = {k:adata_subset_in_tissue(v) for k,v in adata_dict0.items()}
...
import os
if os.path.exists(f"../../results/ffpe2/histogene_cor_{test_sample_orig}.csv"):
...
# with open(f"../../results/ffpe/histogene_preds_{test_sample_orig}.pkl", 'wb') as f:
...
df.to_csv("../../results/visium_markers/histogene_cor_{}.csv".format(test_sample_orig))

with open("../../results/visium_markers/histogene_times.txt", 'a') as f:
