...
samples=[*[f'A{i}' for i in range(2,7)],*[f'B{i}' for i in range(1,7)],
...
df.to_csv("../results/her2st_new/stimage_cor_{}.csv".format(test_sample))

with open("../results/her2st_new/stimage_times.txt", 'a') as f:
